...
"use strict";
const amountCategories = document.querySelector('#categories').children.length;
console.log(`В списке ${amountCategories} категории`);

const categoryDescription = document.querySelectorAll('#categories .item');
categoryDescription.forEach(category => console.log(`Категория: ${category.firstElementChild.textContent} \n Количество элементов: ${category.querySelectorAll('li').length}`));
